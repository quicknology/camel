...
/**
 * <p>Java class for LetterContent complex type.
 * 
 ...
 *         &lt;element name="claimLetterSection" type="{http://vbms.vba.va.gov/cdm}ClaimLetterSection" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "LetterContent", propOrder = {
    "createDt",
    "lastUpdateDt",
    "expirationDt",
    "claimLetterSection"
...
@XmlSeeAlso({
    LetterContention.class,
    DevelopmentActionParagraph.class,
...
public class LetterContent {
    ...
    protected ClaimLetterSection claimLetterSection;
    ...
    /**
     * Gets the value of the claimLetterSection property.
     * 
     * @return
     *     possible object is
     *     {@link ClaimLetterSection }
     *     
     */
    public ClaimLetterSection getClaimLetterSection() {
        return claimLetterSection;
    }

    /**
     * Sets the value of the claimLetterSection property.
     * 
     * @param value
     *     allowed object is
     *     {@link ClaimLetterSection }
     *     
     */
    public void setClaimLetterSection(ClaimLetterSection value) {
        this.claimLetterSection = value;
    }
